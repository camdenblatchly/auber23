...
here::i_am("R/bb-choropleth-co.Rmd")
...
save_plot(fig_jenks, here::here("export/choropleth_jenks_co_bb.png"), chart_height = 8)
...
fig_equal <- get_choropleth(chrt_dta, breaks, chrt_labels) +
  theme(
    legend.text = element_text(margin = margin(r = 10)),
    legend.key.size = unit(12, "pt"),
    legend.margin = margin(t = 5)
...
save_plot(fig_equal, here::here("export/choropleth_equal_co_bb_bb.png"), chart_height = 8)
...
fig_quantile <- get_choropleth(chrt_dta, breaks, chrt_labels) +
  theme(
    legend.text = element_text(margin = margin(r = 10)),
    legend.key.size = unit(12, "pt"),
    legend.margin = margin(t = 5)
...
save_plot(fig_quantile, here::here("export/choropleth_quantile_co_bb.png"), chart_height = 8)
...
fig_sd <- get_choropleth(chrt_dta, breaks, chrt_labels) +
  theme(
    legend.text = element_text(margin = margin(r = 10)),
    legend.key.size = unit(12, "pt"),
    legend.margin = margin(t = 5)
...
save_plot(fig_sd, here::here("export/choropleth_sd_co_bb.png"), chart_height = 8)
...
save_plot(fig_dist, here::here("export/bb_25_3_hist_bb.png"))
